...
Parampreet Singh
paramps
Problem 4c, MSCS Module 1, Fall2023
09/26/2023
Aim: To print a right triangle of c's of height n filling the upper left diagonal, where n is input by the user.
*/
...
int main(int args, char *argsv[]){
    ...
    for (int i = 0; i < num_rows; i++){
        ...
        // Used if else to print spaces in lower left diagonal and c's in upper left diagonal
